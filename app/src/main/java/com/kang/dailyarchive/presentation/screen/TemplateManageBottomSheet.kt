...
import com.kang.dailyarchive.presentation.theme.PriorityHigh
import com.kang.dailyarchive.presentation.theme.PriorityLow
import com.kang.dailyarchive.presentation.theme.PriorityMedium
import com.kang.dailyarchive.presentation.viewmodel.TaskViewModel
...
fun TemplateManageBottomSheet(
    ...
    goalsWithProgress: List<com.kang.dailyarchive.presentation.viewmodel.GoalWithProgress> = emptyList(),
    onDismiss: () -> Unit,
) {
...
private fun GroupDetailScreen(
    group:         RoutineTemplateGroupWithTasks,
    goalsWithProgress: List<com.kang.dailyarchive.presentation.viewmodel.GoalWithProgress>,
    onBack:        () -> Unit,
    onAddTask:     (title: String, description: String?, priority: Int, goalId: Long?) -> Unit,
    onUpdateTask:  (task: com.kang.dailyarchive.data.local.entity.RoutineTemplateTaskEntity, title: String, description: String?, priority: Int, goalId: Long?) -> Unit,
    ...
    var editingTask      by remember { mutableStateOf<com.kang.dailyarchive.data.local.entity.RoutineTemplateTaskEntity?>(null) }
